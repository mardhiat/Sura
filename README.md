...
Sura App is a Streamlit web app for selling Sura hijabs online. Customers can browse products, add them to a cart, choose a payment method (Apple Pay, Zelle, CashApp, or PayPal), and submit orders. All orders are stored in a backend database for tracking, and the store owner contacts customers once payment is received to process their orders.s